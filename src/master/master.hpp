...
private:
  ...
  public:
    ...
    process::Future<process::http::Response> maintenanceSchedule(
        const process::http::Request& request) const;
    process::Future<process::http::Response> _maintenanceSchedule(
    ...
    process::Future<process::http::Response> maintenanceStop(
        const process::http::Request& request) const;
    process::Future<process::http::Response> _maintenanceStop(
        const MachineInfos& machines,
        bool operationResult) const;
  ...
  // Holds the maintenance info of each machine scheduled for maintenance.
  hashmap<MachineInfo, MaintenanceInfo> maintenanceStatuses;

  // Holds the maintenance schedule, as given by the operator.
  std::list<mesos::maintenance::Schedule> maintenanceSchedules;
